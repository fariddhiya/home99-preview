...
export default function RukoDetailPage() {
  ...
  const propertyData = {
    ...
    description:
      "Ruko 3 lantai dengan lokasi strategis di jalan utama Fatmawati. Cocok untuk berbagai jenis usaha dengan visibilitas tinggi dan akses mudah.",
    longDescription:
      "Ruko 3 lantai dengan lokasi strategis di jalan utama Fatmawati. Cocok untuk berbagai jenis usaha dengan visibilitas tinggi dan akses mudah.\n\nRuko ini memiliki luas bangunan 150 m² dengan lebar muka 5 meter. Lantai 1 ideal untuk area display atau toko, lantai 2 untuk kantor atau ruang kerja, dan lantai 3 untuk gudang atau tempat penyimpanan. Dilengkapi dengan area parkir di depan yang dapat menampung 2 mobil.\n\nLokasi sangat strategis, berada di jalan utama Fatmawati dengan lalu lintas ramai. Dekat dengan pusat perbelanjaan, perkantoran, dan perumahan. Akses mudah ke berbagai area Jakarta Selatan dan memiliki potensi bisnis yang sangat baik.",
    type: "Ruko",
    status: "Dijual",
    floors: 3,
    bathrooms: 2,
    ...
    facilities: ["Area Parkir", "Jalan Lebar", "Akses Jalan Utama", "Listrik 3 Phase"],
    nearbyFacilities: ["Pusat Perbelanjaan", "Perkantoran", "Perumahan", "Restoran", "Bank"],
    yearBuilt: 2018,
    certificate: "SHM - Sertifikat Hak Milik",
    images: [
      "/placeholder.svg?height=600&width=800&text=Ruko+Fatmawati+1",
      "/placeholder.svg?height=600&width=800&text=Ruko+Fatmawati+2",
      "/placeholder.svg?height=600&width=800&text=Ruko+Fatmawati+3",
      "/placeholder.svg?height=600&width=800&text=Ruko+Fatmawati+4",
      "/placeholder.svg?height=600&width=800&text=Ruko+Fatmawati+5",
    ],
    agent: {
      name: "Siti Rahayu",
      phone: "+62 812-9876-5432",
      email: "siti@home99.id",
        ...
        <div className="bg-muted/30 py-2">
          <div className="container">
            <div className="flex items-center text-sm text-muted-foreground">
              ...
              <span className="mx-2">/</span>
              <Link href="/properti/ruko" className="hover:text-primary">
                Ruko
              </Link>
              <span className="mx-2">/</span>
        ...
        <div className="container py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="flex flex-col items-center p-4 bg-muted/50 rounded-lg">
                    ...
                    <span className="text-sm text-muted-foreground">Jumlah Lantai</span>
                    <span className="font-bold">{propertyData.floors}</span>
                  </div>
                  <div className="flex flex-col items-center p-4 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4">
                  ...
                  <div className="flex items-center">
                    <span className="w-40 text-muted-foreground">Luas Tanah</span>
                    <span className="font-medium">{propertyData.landSize} m²</span>
                  </div>
                  <div className="flex items-center">
              ...
              {/* Business Potential */}
              <div>
                <h2 className="text-2xl font-bold mb-4">Potensi Bisnis</h2>
                <div className="p-4 bg-muted/50 rounded-lg">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <Store className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Lokasi strategis di jalan utama dengan visibilitas tinggi</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Store className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Cocok untuk berbagai jenis usaha: retail, kantor, klinik, atau restoran</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Store className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Area dengan lalu lintas tinggi dan banyak aktivitas komersial</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Store className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Dekat dengan area perumahan dan perkantoran yang mendukung bisnis</span>
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <TabsContent value="floorplan" className="mt-4">
                    <div className="relative h-[400px] rounded-lg overflow-hidden bg-muted flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground">Denah Ruko</p>
                        <p className="text-sm text-muted-foreground">Denah lantai 1, 2, dan 3</p>
                      </div>
                    </div>
                  </TabsContent>
                </Tabs>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-bold text-lg mb-4">Kalkulator ROI Bisnis</h3>
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium">Harga Properti</label>
                      <div className="p-2 border rounded-md mt-1">Rp 3.200.000.000</div>
                    </div>
                    <div>
                      <label className="text-sm font-medium">Estimasi Pendapatan Sewa/Bulan</label>
                      <div className="p-2 border rounded-md mt-1">Rp 25.000.000</div>
                    </div>
                    <div>
                      <label className="text-sm font-medium">Biaya Operasional/Bulan</label>
                      <div className="p-2 border rounded-md mt-1">Rp 5.000.000</div>
                    </div>
                    <Separator />
                    <div>
                      <label className="text-sm font-medium">Pendapatan Bersih/Tahun</label>
                      <div className="p-2 bg-primary/10 rounded-md mt-1 font-bold">Rp 240.000.000</div>
                    </div>
                    <div>
                      <label className="text-sm font-medium">ROI Tahunan</label>
                      <div className="p-2 bg-primary/10 rounded-md mt-1 font-bold">7.5%</div>
                    </div>
        ...
        <div className="container py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {similarProperties.map((property) => (
              <Link href={`/properti/ruko/${property.id}`} key={property.id}>
